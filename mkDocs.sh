...
docker run -a STDERR --rm -i -v `pwd`:/docs gisaia/typedocgen:0.0.10 generatedoc --entryPoints projects/arlas-components/src/public-api.ts --tsconfig projects/arlas-components/tsconfig.lib.json

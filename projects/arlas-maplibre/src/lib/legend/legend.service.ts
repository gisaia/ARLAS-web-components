...
import { CirclePaintProps, FillPaintProps, HeatmapPaintProps, LayerSpecification, LinePaintProps, SymbolPaintProps, TypedStyleLayer } from 'maplibre-gl';
...
export class MaplibreLegendService extends LegendService {
    ...
    public getCircleLegend(paint: CirclePaintProps, visibileMode: boolean, legendData: Map<string, LegendData>, layer: TypedStyleLayer): CircleLegend {
        const p: CirclePaintProps = paint;
        const colors = MaplibreLegendService.buildColorLegend(p['circle-color'], visibileMode, legendData, layer.filter, this.translate);
    ...
    public getHeatmapLegend(paint: HeatmapPaintProps, visibileMode: boolean, legendData: Map<string, LegendData>, layer: TypedStyleLayer): HeatmapLegend {
    ...
    public getLabelLegend(paint: SymbolPaintProps, visibileMode: boolean, legendData: Map<string, LegendData>, layer: TypedStyleLayer): LabelLegend {

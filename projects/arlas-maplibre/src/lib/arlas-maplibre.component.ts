...
import { ElementIdentifier } from 'arlas-components';
...
export class ArlasMaplibreComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
   ...
   */
  @Input() public mapLayers: MapLayers<TypedStyleLayer>;
  ...
  public addVisualisation(visualisation: VisualisationSetConfig, layers: Array<any>, sources: Array<ArlasMapSource<MaplibreSourceType>>): void {

export { MapSettingsComponent, MapSettingsService, GeoQuery, GeometrySelectModel, OperationSelectModel, MapSettingsDialogComponent, GeoQueryOperator } from './lib/map-settings/map-settings.component';
...
export { AbstractArlasMapGL, ArlasMapOffset, CROSS_LAYER_PREFIX, GEOJSON_SOURCE_TYPE, LAYER_SWITCHER_TOOLTIP, MapConfig, RESET_BEARING, ZOOM_IN, ZOOM_OUT } from './lib/map/AbstractArlasMapGL';
export { ConfigControls, ControlButton, ControlPosition, ControlsOption, DrawConfigControl, DrawControlsOption, IconConfig, PitchToggle, PitchToggleConfigControls } from './lib/map/model/controls';
export { MapExtent } from './lib/map/model/extent';
export { ARLAS_ID, ARLAS_VSET, ExternalEvent, ExternalEventLayer, FILLSTROKE_LAYER_PREFIX, FillStroke, HOVER_LAYER_PREFIX, LayerEvents, LayerMetadata, MapLayers, MetadataHiddenProps, PaintColor, PaintValue, SCROLLABLE_ARLAS_ID, SELECT_LAYER_PREFIX, getLayerName, ArlasDataLayer, ArlasPaint } from './lib/map/model/layers';

...
@Component({
  selector: 'arlas-mapbox',
  templateUrl: './arlas-mapbox.component.html',
  styleUrls: ['./arlas-mapbox.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ArlasMapboxComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
   ...
   */
  public addVisualisation(visualisation: VisualisationSetConfig, layers: Array<AnyLayer>, sources: Array<ArlasMapSource<MapboxSourceType>>): void {

...
import {MapglMapblibreComponent} from "./mapgl-mapblibre/mapgl-mapblibre.component";
import {MapglMapboxComponent} from "./mapgl-mapbox/mapgl-mapbox.component";
import {
  CROSS_LAYER_PREFIX,
  GEOJSON_SOURCE_TYPE,
  IconConfig,
...
@Component({
  selector: 'arlas-mapgl-common',
  template: '',
  styles: ['']
})
export class MapglMapCommonComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {

  @ViewChild('mapRef') mapRef: MapglMapblibreComponent | MapglMapboxComponent;

  public  map: any; //TODO : can create a same type here
  public draw: any;
  public zoom: number;
  ...
  @Input() public providerType: 'mapbox' | 'maplibre' = 'mapbox';
 ...
 */
  ...
  */
  ...
  public constructor(protected http: HttpClient, protected drawService: MapboxAoiDrawService,
                     ...
                     protected _snackBar: MatSnackBar, protected translate: TranslateService) {
  ...
  public paddedFitBounds(bounds: maplibregl.LngLatBoundsLike, options?: maplibregl.FitBoundsOptions) {
    ...
    (<maplibregl.Map>this.map).fitBounds(bounds, paddedOptions);
  }
